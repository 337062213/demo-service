...
public class ExportPDFUtilRemote {  
     
     public static void exportPDF( HttpServletResponse response) throws Exception, DocumentException {  
         ...
         PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(new File("C:\\Users\\EDZ\\Desktop\\POReceiveReport.pdf")));
